...
multi_patch_fun <-
  ...
  ## Note: seed_patch can be a vector, in which case a different one will be chosen each year
  ...
  migration$setup(graph, beta_breed = 0.1, beta_migrate = 0.025, doy_breed = doy_breed, doy_migrate = doy_migrate)
